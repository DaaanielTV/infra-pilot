...
@app.command()
def register(ctx: typer.Context, name: str = typer.Argument(..., help="Service name"), endpoint: str = typer.Argument(..., help="Health endpoint"), interval: int = typer.Argument(..., help="Check interval")) -> None:
    """Register a service
...
@app.command()
def forecast(ctx: typer.Context, service_id: str = typer.Argument(..., help="Service ID")) -> None:
    """Health forecast
