...
app = typer.Typer(help="Packet capture management commands")
...
def list(
    ...
    data = result if isinstance(result, _list_type) else result.get("captures", result)
...
def start(
    ...
    filter_expr: str = typer.Option(None, "--filter", "-f", help="BPF filter expression"),
):
