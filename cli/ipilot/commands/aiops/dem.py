...
@app.command()
def create(ctx: typer.Context, name: str = typer.Argument(..., help="Monitor name"), url: str = typer.Argument(..., help="Target URL"), interval: int = typer.Option(60, help="Check interval")):
    """Create a monitor"""
    client = _get_client(ctx)
